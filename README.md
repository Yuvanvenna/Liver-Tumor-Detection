This project focuses on detecting liver tumors using a hybrid quantum-classical approach. It utilizes the 3D-IRCADb1 dataset, which contains annotated liver CT scans, for model training.
